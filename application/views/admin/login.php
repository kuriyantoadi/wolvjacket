                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 text-center">
                                        <a href="index.php" class="d-block auth-logo">
                                            <img src="<?= base_url() ?>assets/images/logo-wolv.png" alt="" height="100"> 
                                            <br><span class="logo-txt">Wolv Jacket</span>
                                        </a>
                                    </div>
                                    <div class="auth-content my-auto">
                                        <!-- <div class="text-center">
                                            <h5 class="mb-0">Halaman Login Admin</h5>
                                            <p class="text-muted mt-2">Vote Teacher 2023</p>
                                        </div> -->
