<?php foreach ($tampil as $row): ?>
    <div class="modal fade bs-example-modal-xl" id="editModal<?= $row->no_faktur_transaksi ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myExtraLargeModalLabel">Detail Transaksi - <?= $row->no_faktur_transaksi ?></h5>
                ...
                <div class="modal-body">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            $filtered_data = $this->M_transaksi->get_data_by_no_faktur($row->no_faktur_transaksi);
                            $counter = 1;
                            foreach ($filtered_data as $item): ?>
                                <tr>
                                    <td><?= $counter ?></td>
                                    <td><?= $item->no_faktur_transaksi ?></td>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Daftar Transaksi</h4>
            ...
            <div class="row">
                <div class="col-12 mb-2">
                    ...
                    <div class="d-flex gap-2 flex-wrap mb-1">
                        <a href="<?= site_url('Transaksi/transaksi_tambah') ?>" class="btn btn-info btn-sm waves-effect waves-light">Tambah</a>
                    </div>  
  ...
  <script>
        ...
        $('#datatable').DataTable({
            ...
            "ajax": {
                ...
                "url": "<?= site_url('Ajax/ajax_transaksi') ?>",
                "type": "POST"
            },
            "columnDefs": [
                {
