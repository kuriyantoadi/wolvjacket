                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <!-- item-->
                                <a class="dropdown-item" href="<?= site_url('index.php/Kasir/profil') ?>"><i class="mdi mdi-face-profile font-size-16 align-middle me-1"></i> Profil</a>
                                <a class="dropdown-item" href="<?= site_url('index.php/Kasir/password') ?>"><i class="mdi mdi-lock font-size-16 align-middle me-1"></i>Password</a>
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <!-- <li>
                                ...
                                <ul class="sub-menu" aria-expanded="true">
                                    <li><a href="<?= base_url() ?>Kasir/barang" data-key="t-level-1-1">Data Barang</a></li>
                                    <li><a href="<?= base_url() ?>Kasir/kategori_barang" data-key="t-level-1-2">Kategori Barang</a></li>
                                    <li><a href="<?= base_url() ?>Kasir/brand" data-key="t-level-1-3">Brand</a></li>
