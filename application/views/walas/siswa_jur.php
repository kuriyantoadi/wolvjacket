            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">  
                        ...
                        <p>Pilih Kelas</p>
                        <select id="select-opt" class="form-control mb-3">
                            <option value="">Pilih kelas</option>

                            <?php foreach ($kelas as $row_kelas) { ?>
                            <option value="<?= base_url() ?>Walas/siswa_jur/<?= $row_kelas->id_kelas ?>"> <?= $row_kelas->tingkatan.' '.$row_kelas->nama_jurusan.' '.$row_kelas->kode_kelas ?></option>
                            <?php } ?>
