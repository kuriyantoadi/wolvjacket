        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myLargeModalLabel">Refund - Tambah Item Barang</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    
                <!-- awal isi modal -->
                <?= form_open('Refund/refund_edit_tambah'); ?>
                <form class="m-t-40" novalidate>

                <?php foreach ($tampil as $row_faktur): ?>

                <div class="form-group">
                    <label class="control-label mt-3" for="email">No Faktur Refund:</label>
                    <input type="hidden" name="no_faktur_refund" value="<?= $row_faktur->no_faktur_refund ?>">
                    <input type="hidden" name="id_refund" value="<?= $row_faktur->id_refund ?>">
                    <input type="text" class="form-control" placeholder="" name="no_faktur_refund" value="<?= $row_faktur->no_faktur_refund ?>" required readonly>
                </div>
...
<!-- Awal modal Edit Keterangan ============================================================== -->
    ...
    <div class="modal fade bs-example-modal-lg" id="editKeterangan" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myLargeModalLabel">Edit Transaksi Refund</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    
                <!-- awal isi modal -->
                <?= form_open('Refund/refund_edit_keterangan'); ?>
                <?php foreach ($tampil as $row){ ?>
                <?php $id_refund = $row->id_refund ?>
                <form class="m-t-40" novalidate>

                <div class="form-group">
                    <label class="control-label mt-3" for="email">No Faktur :</label>
                    <input type="hidden" name="id_refund" value="<?= $row->id_refund ?>">
                    <input type="text" class="form-control" placeholder="" name="no_faktur_refund" value="<?= $row->no_faktur_refund ?>" required readonly>
                </div>
...
<?php foreach ($tampil_barang_modal as $row){ ?>
    ...
    <div class="modal fade bs-example-modal-lg" id="editJumlah<?= $row->id_refund_barang ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <!-- awal isi modal -->
                <?= form_open('Refund/refund_edit_jumlah'); ?>
            
                <form class="m-t-40" novalidate>

                <div class="form-group">
                    <label class="control-label mt-3" for="email">Nama Barang : </label>
                    <input type="hidden" name="id_refund_barang" value="<?= $row->id_refund_barang ?>">
                    <input type="hidden" name="no_faktur_refund" value="<?= $row->no_faktur_refund ?>">
                    <input type="hidden" name='id_refund' value="<?= $id_refund ?>">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Edit Transaksi Refund</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12 mb-2">
                    ...
                    <div class="d-flex gap-2 flex-wrap mb-1">
                        <a type="button" href="<?= base_url() ?>Refund/index" class="btn btn-sm btn-secondary waves-effect waves-light" >Kembali</a>
                    ...
                    <div class="card">  
                        ...
                        <table id='datatable2' class="table table-bordered dt-responsive nowrap w-100">
                            ...
                            <tbody>
                                ...
                                <?php $id_refund = $row->id_refund ?>
                                    <tr>
                                        <td><center><?= $row->no_faktur_refund ?></td>
                                        ...
                                        <td><center>
                                            ...
                                            <a class="btn btn-success btn-sm" href="<?= site_url('Admin/tambah_stok_print/'. $row->id_refund) ?>"><i class="bx bxs-printer"></i>Print</a>
                                        </td>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">  
                        <div class="card-body">
                        <h3 class="mb-sm-3 font-size-18">Daftar Barang Refund</h3>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($faktur_barang as $row) { ?>
                                    <tr>
                                        ...
                                        <td><center>
                                            <button class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#editJumlah<?= $row->id_refund_barang ?>"><i class="bx bxs-edit"></i>Edit</button>
                                            <a href="<?= site_url('Refund/refund_edit_hapus/'.$row->id_refund_barang.'/'.$id_refund) ?>" onclick="return confirm('Yakin hapus data item Barang <?= $row->nama_barang ?>' )"  class="btn btn-danger btn-sm"><i class="bx bxs-trash"></i> Hapus</a>
                                        </td>
                                    </tr>
